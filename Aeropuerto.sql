...
INSERT INTO Pasajeros(nombre,apellido_p,genero,pasaporte) VALUES('David','Salda�a','Masculino','A234874D')
...
-- - Pilotos
INSERT INTO Pilotos(nombre,apellido,genero,cedula) VALUES ('Juan', 'P�rez', 'Masculino', '12345678')
INSERT INTO Pilotos(nombre,apellido,genero,cedula) VALUES ('Mar�a', 'Gonz�lez', 'Femenino', '23456789')
INSERT INTO Pilotos(nombre,apellido,genero,cedula) VALUES ('Carlos', 'L�pez', 'Masculino', '34567890')
INSERT INTO Pilotos(nombre,apellido,genero,cedula) VALUES ('Ana', 'Mart�nez', 'Femenino', '45678901')
INSERT INTO Pilotos(nombre,apellido,genero,cedula) VALUES ('Pedro', 'S�nchez', 'Masculino', '56789012')
INSERT INTO Pilotos(nombre,apellido,genero,cedula) VALUES ('Laura', 'D�az', 'Femenino', '67890123')
INSERT INTO Pilotos(nombre,apellido,genero,cedula) VALUES ('Miguel', 'Rodr�guez', 'Masculino', '78901256')
INSERT INTO Pilotos(nombre,apellido,genero,cedula) VALUES ('Sof�a', 'L�pez', 'Femenino', '89012345')
-- - Vuelos
...
INSERT INTO Vuelos (pais_o, pais_d, fecha_salida, fecha_llegada, aeropuerto_o, aeropuerto_d, precio,id_piloto) 
VALUES ('Espa�a', 'Italia', '2024-04-22 10:00:00', '2024-04-23 14:00:00', 'MAD', 'FCO', 300,2)

INSERT INTO Vuelos (pais_o, pais_d, fecha_salida, fecha_llegada, aeropuerto_o, aeropuerto_d, precio,id_piloto) 
VALUES ('Alemania', 'Reino Unido', '2024-04-24 12:00:00', '2024-04-25 16:00:00', 'FRA', 'LHR', 250,3)

INSERT INTO Vuelos (pais_o, pais_d, fecha_salida, fecha_llegada, aeropuerto_o, aeropuerto_d, precio,id_piloto) 
VALUES ('Jap�n', 'Australia', '2024-04-26 14:00:00', '2024-04-27 18:00:00', 'NRT', 'SYD', 800,4)

INSERT INTO Vuelos (pais_o, pais_d, fecha_salida, fecha_llegada, aeropuerto_o, aeropuerto_d, precio,id_piloto) 
VALUES ('Brasil', 'Argentina', '2024-04-28 16:00:00', '2024-04-29 20:00:00', 'GRU', 'EZE', 200,5)

INSERT INTO Vuelos (pais_o, pais_d, fecha_salida, fecha_llegada, aeropuerto_o, aeropuerto_d, precio,id_piloto) 
VALUES ('Canad�', 'M�xico', '2024-04-30 18:00:00', '2024-05-01 22:00:00', 'YYZ', 'MEX', 400,6)

INSERT INTO Vuelos (pais_o, pais_d, fecha_salida, fecha_llegada, aeropuerto_o, aeropuerto_d, precio,id_piloto) 
VALUES ('China', 'India', '2024-05-02 20:00:00', '2024-05-03 00:00:00', 'PEK', 'DEL', 600,7)

INSERT INTO Vuelos (pais_o, pais_d, fecha_salida, fecha_llegada, aeropuerto_o, aeropuerto_d, precio,id_piloto) 
VALUES ('Rusia', 'Sud�frica', '2024-05-04 22:00:00', '2024-05-05 02:00:00', 'SVO', 'JNB', 700,8)
-- - Tickets
...
SELECT * FROM Pilotos
SELECT * FROM Vuelos
>>>>>>> 00b9f1930ef085f02a558f63a944a105707ca5ba